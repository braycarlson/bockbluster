...
<?php if ($row): ?>
    <div class="grid grid-cols-4 mt-4 max-w-full" style="width:800px">
        <div class="col-start-1 col-span-1 font-bold">Store ID</div>
        <div class="col-start-2 col-span-3"><?= $profile["SID"] ?></div>
    </div>
    ...
    <div class="grid grid-cols-2 place-items-center mt-8 max-w-full" style="width:800px">
        <a href="update_store_form.php?SID=<?= $profile["SID"]; ?>">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
            </svg>
        </a>

        <a href="delete_store.php?SID=<?= $profile["SID"]; ?>">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
